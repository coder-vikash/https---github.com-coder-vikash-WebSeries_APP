...
const SeriesCard = ({ web }) => {
  ...
  // Get the link from the web object - checking multiple possible properties
  const seriesLink = web.link || "#";
      ...
      <div className="card h-100 shadow-sm border-0 overflow-hidden">
        ...
        <div className="position-relative">
          ...
          <div className="position-absolute bottom-0 start-0 w-100 p-3 bg-dark bg-opacity-75">
            <h5 className="text-white mb-0">{web.title || web.Title}</h5>
            <small className="text-white-50">{web.subtitle || web.Type}</small>
          </div>
        </div>
